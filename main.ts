...
export class AgileTaskNotesPluginSettingTab extends PluginSettingTab {
    ...
    .setDesc('Set the inital content for each new task note. Available variables: {{TASK_ID}}, {{TASK_TITLE}}, {{TASK_TYPE}}, {{TASK_STATE}}, {{TASK_ASSIGNEDTO}}, {{TASK_LINK}}, {{TASK_DESCRIPTION}}, {{TASK_DUE}}')
    .addTextArea(text => {
        text
